...
public class a {
    ...
    private static String[] rotate(final String[] img) {
        int w = img[0].length();
    ...
    private static String[] flip(final String[] img) {
    ...
    private static String[] zoom(final String[] img) {
    ...
    private static String zoomLine(final String line) {
        StringBuilder newLine = new StringBuilder();
